...
static ErlDrvData RE_start(ErlDrvPort port, char *buf);
static void RE_stop(ErlDrvData drv_data);

static ErlDrvEntry RE_driver_entry;
...
DRIVER_INIT(RE_drv)
{
    ...
    RE_driver_entry.init         = NULL;   /* Not used */
    RE_driver_entry.start        = RE_start;
    RE_driver_entry.stop         = RE_stop;
    RE_driver_entry.output       = RE_from_erlang;
    RE_driver_entry.ready_input  = NULL;
    RE_driver_entry.ready_output = NULL;
    RE_driver_entry.driver_name  = "RE_drv";
    RE_driver_entry.finish       = RE_finish;
    RE_driver_entry.outputv      = NULL;
    return &RE_driver_entry;
}
